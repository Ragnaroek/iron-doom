use crate::{
    fixed::{FRAC_BITS, ZERO, new_fixed_i32, new_fixed_u32},
...
fn test_setup_level() -> Result<(), String> {
    ...
    assert_eq!(level.segs[0].v1.x, new_fixed_u32(1552 << FRAC_BITS));
    assert_eq!(level.segs[0].v1.y, new_fixed_i32(-2560 << FRAC_BITS));
    assert_eq!(level.segs[0].v2.x, new_fixed_u32(1552 << FRAC_BITS));
    assert_eq!(level.segs[0].v2.y, new_fixed_i32(-2432 << FRAC_BITS));
    ...
    assert_eq!(level.segs[731].v1.x, new_fixed_u32(3040 << FRAC_BITS));
    assert_eq!(level.segs[731].v1.y, new_fixed_i32(-4672 << FRAC_BITS));
    assert_eq!(level.segs[731].v2.x, new_fixed_u32(2976 << FRAC_BITS));
    assert_eq!(level.segs[731].v2.y, new_fixed_i32(-4672 << FRAC_BITS));
